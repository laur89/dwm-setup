...
static const char colors[NUMCOLORS][ColLast][9] = {
  ...
  { "#282a2e", "#7f8185", "#1d1f21" }, // D = a bit lighter gray than normal on black; for occupied and monocle tab bar non-selected
  { "#282a2e", "#c5c8c6", "#5f6267" }, // E = used for selected title in monocle tab bar
  { "#91a2be", "#b5bd68", "#FFFFFF" }, // F = for float client borders; index 0 is norma, 1 selected, 2 unused
};
